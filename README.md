...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/cym-03/tkbgc-material-generator)

点击上方按钮，登录 Render 后按提示设置环境变量即可获得公开链接。
...
```bash
git clone https://github.com/cym-03/tkbgc-material-generator.git
